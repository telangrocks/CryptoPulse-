...
export default function SplashScreen() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      {/* Flash overlay */}
      {showFlash && (
        <div className="absolute inset-0 bg-white opacity-30 z-10 animate-pulse"></div>
      )}
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-3/4 right-1/4 w-1 h-1 bg-blue-400 rounded-full animate-ping opacity-30" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-1/4 left-1/3 w-1.5 h-1.5 bg-purple-300 rounded-full animate-ping opacity-25" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 right-1/3 w-1 h-1 bg-pink-400 rounded-full animate-ping opacity-20" style={{ animationDelay: '0.5s' }}></div>
      </div>
      ...
      <div className="text-center z-20 animate-fade-in opacity-0" style={{animation: 'fadeIn 1s ease-out forwards'}}>
        ...
        <div className="mb-12">
          <div className="relative mb-6">
            ...
            <div className="absolute inset-0 w-32 h-32 mx-auto bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 rounded-3xl blur-xl opacity-50 animate-pulse"></div>
          </div>
