  ...
  const fetchPerformanceData = useCallback(async () => {
    try {
      ...
      const [metricsData, tradesData, chartDataResponse] = await Promise.all([
        callBack4AppFunction('getPerformanceMetrics', { period: selectedPeriod }),
        callBack4AppFunction('getTradeHistory', { period: selectedPeriod, limit: 50 }),
        callBack4AppFunction('getPortfolioChart', { period: selectedPeriod })
      ])
